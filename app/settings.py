...
MONGO_URI = os.environ.get('MONGO_URI', 'mongodb://rleitao:kIller93@ds259410.mlab.com:59410/connect_to_py')
# API version. Will be used in conjunction with URL_PREFIX to build API endpoints (e.g., v1 will be rendered to /v1/<endpoint>).
# Defaults to ''.
API_VERSION = ''

# URL prefix for all API endpoints. Will be used in conjunction with API_VERSION
# to build API endpoints (e.g., api will be rendered to /api/<endpoint>). Defaults to ''.
URL_PREFIX = ''
